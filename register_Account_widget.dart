                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    await ExpenseListRecord.collection
                                        .doc()
                                        .set(createExpenseListRecordData(
                                          expenseUser: currentUserReference,
                                        ));

                                    await DebtListRecord.collection
                                        .doc()
                                        .set(createDebtListRecordData(
                                          debtUser: currentUserReference,
                                        ));
