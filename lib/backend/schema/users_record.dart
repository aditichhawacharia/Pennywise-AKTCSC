...
class UsersRecord extends FirestoreRecord {
  ...
  // "monthlyIncomeAmount" field.
  double? _monthlyIncomeAmount;
  double get monthlyIncomeAmount => _monthlyIncomeAmount ?? 0.0;
  bool hasMonthlyIncomeAmount() => _monthlyIncomeAmount != null;
  ...
  void _initializeFields() {
    ...
    _monthlyIncome = snapshotData['monthlyIncome'] as String?;
    _monthlyIncomeAmount =
        castToType<double>(snapshotData['monthlyIncomeAmount']);
  }
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    return e1?.displayName == e2?.displayName &&
        ...
        e1?.monthlyIncomeAmount == e2?.monthlyIncomeAmount;
  }
