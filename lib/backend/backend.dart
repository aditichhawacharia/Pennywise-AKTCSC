...
import 'schema/expense_list_record.dart';
import 'schema/debts_record.dart';
import 'schema/debt_list_record.dart';
...
export 'schema/expense_list_record.dart';
export 'schema/debts_record.dart';
export 'schema/debt_list_record.dart';
...
/// Functions to query ExpenseListRecords (as a Stream and as a Future).
Future<int> queryExpenseListRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ExpenseListRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ExpenseListRecord>> queryExpenseListRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ExpenseListRecord.collection,
      ExpenseListRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ExpenseListRecord>> queryExpenseListRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query DebtListRecords (as a Stream and as a Future).
Future<int> queryDebtListRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DebtListRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DebtListRecord>> queryDebtListRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DebtListRecord.collection,
      DebtListRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DebtListRecord>> queryDebtListRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
