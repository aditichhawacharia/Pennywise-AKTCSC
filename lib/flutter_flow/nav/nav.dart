...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'createExpenseBegin',
          path: '/createExpenseBegin',
          builder: (context, params) => const CreateExpenseBeginWidget(),
        ),
        FFRoute(
          name: 'MY_Card',
          path: '/mYCard',
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'MY_Expenses')
        ...
        FFRoute(
          ...
          path: '/onboardingDebts',
          builder: (context, params) => const OnboardingDebtsWidget(),
        ),
        FFRoute(
          name: 'createDebtBegin',
          path: '/createDebtBegin',
          builder: (context, params) => const CreateDebtBeginWidget(),
        ),
        FFRoute(
          name: 'createDebt',
          path: '/createDebt',
          builder: (context, params) => const CreateDebtWidget(),
        ),
        FFRoute(
          name: 'MY_Debts',
          path: '/mYDebts',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'MY_Debts')
              : const MYDebtsWidget(),
        ),
        FFRoute(
          name: 'DebtDetails',
          path: '/debtDetails',
          builder: (context, params) => DebtDetailsWidget(
            debtDetails: params.getParam(
              'debtDetails',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['debts'],
            ),
          ),
        ),
        FFRoute(
          ...
          path: '/budget',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'budget')
              : const BudgetWidget(),
        ),
        FFRoute(
          name: 'UpdateDebt',
          path: '/updateDebt',
          builder: (context, params) => UpdateDebtWidget(
            debtName: params.getParam(
              'debtName',
              ParamType.String,
            ),
            debtdetails: params.getParam(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Phone_Wallpaper_Lock_and_Home_Screen_(1).png',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
