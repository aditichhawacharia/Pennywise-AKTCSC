...
import 'create_debt_begin_model.dart';
export 'create_debt_begin_model.dart';

class CreateDebtBeginWidget extends StatefulWidget {
  const CreateDebtBeginWidget({super.key});

  @override
  State<CreateDebtBeginWidget> createState() => _CreateDebtBeginWidgetState();
}

class _CreateDebtBeginWidgetState extends State<CreateDebtBeginWidget>
    with TickerProviderStateMixin {
  late CreateDebtBeginModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateDebtBeginModel());

    _model.debtAmtTextController ??= TextEditingController();
    _model.debtAmtFocusNode ??= FocusNode();
      ...
      body: Form(
        ...
        child: Column(
          ...
          children: [
                      ...
                      Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              0.0, 16.0, 0.0, 0.0),
                          child: TextFormField(
                            controller: _model.debtAmtTextController,
                            focusNode: _model.debtAmtFocusNode,
                            obscureText: false,
                            ...
                            validator: _model.debtAmtTextControllerValidator
                                .asValidator(context),
                          ).animateOnPageLoad(
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              'u3fdygag' /* Debt APR, enter in form of dec... */,
                            ),
                            hintStyle: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
              ...
              child: Row(
                ...
                children: [
                  Row(
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      StreamBuilder<List<DebtListRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<DebtListRecord>
                              createDebtBegiDebtListRecordList = snapshot.data!;
                          // Return an empty Container when the item does not exist.
                          if (snapshot.data!.isEmpty) {
                            return Container();
                          }
                          final createDebtBegiDebtListRecord =
                              createDebtBegiDebtListRecordList.isNotEmpty
                                  ? createDebtBegiDebtListRecordList.first
                                  : null;
                            ...
                            onPressed: () async {
                              await DebtsRecord.collection
                                  ...
                                  .set(createDebtsRecordData(
                                    ...
                                    userDebts:
                                        createDebtBegiDebtListRecord?.debtUser,
                                    debtAmt: _model.debtAmtTextController.text,
                                    debtAmtNum: double.tryParse(
                                        _model.debtAmtTextController.text),
                                    debtAmtPaid: '0',
                                    debtAmtPaidNum: 0.0,
                                  ));

                              await createDebtBegiDebtListRecord!.reference
                                  .update({
                                ...mapToFirestore(
                                  {
                              ...
                              await createDebtBegiDebtListRecord.reference
                                ...
                                overallMinPay: createDebtBegiDebtListRecord
                                        .overallMinPay +
                                    double.parse(_model
                                        .debtMinPaymentTextController.text),
                                overallPayment: createDebtBegiDebtListRecord
                                        .overallPayment +
                                    double.parse(
                                        _model.debtAmtTextController.text),
                              ));
            ...
            Text(
              FFLocalizations.of(context).getText(
                'yzsrgrkk' /* Tap above to complete request */,
              ),
