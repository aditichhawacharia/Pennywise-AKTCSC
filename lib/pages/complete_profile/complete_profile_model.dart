...
class CompleteProfileModel extends FlutterFlowModel<CompleteProfileWidget> {
  ...
  // State field(s) for yourIncome widget.
  FocusNode? yourIncomeFocusNode;
  TextEditingController? yourIncomeTextController;
  String? Function(BuildContext, String?)? yourIncomeTextControllerValidator;
  ...
  void dispose() {
    ...
    yourIncomeFocusNode?.dispose();
    yourIncomeTextController?.dispose();
  }
}
