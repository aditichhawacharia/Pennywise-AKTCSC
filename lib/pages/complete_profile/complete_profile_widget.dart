...
class _CompleteProfileWidgetState extends State<CompleteProfileWidget>
  ...
  void initState() {
    ...
    _model.yourIncomeTextController ??= TextEditingController();
    _model.yourIncomeFocusNode ??= FocusNode();
              ...
              children: [
                ...
                Padding(
                  padding:
                      const EdgeInsetsDirectional.fromSTEB(20.0, 20.0, 20.0, 0.0),
                  child: TextFormField(
                    controller: _model.yourIncomeTextController,
                    focusNode: _model.yourIncomeFocusNode,
                    obscureText: false,
                    decoration: InputDecoration(
                      labelText: FFLocalizations.of(context).getText(
                        'l0v2l8bq' /* Your Monthly Income (to calcul... */,
                      ),
                      labelStyle:
                          FlutterFlowTheme.of(context).bodySmall.override(
                                fontFamily: 'Lexend',
                    ...
                    keyboardType: TextInputType.number,
                    validator: _model.yourIncomeTextControllerValidator
                        .asValidator(context),
                  ).animateOnPageLoad(
                      ...
                      return FFButtonWidget(
                        onPressed: () async {
                          await buttonLoginUsersRecord.reference
                            ...
                            photoUrl: '',
                            monthlyIncomeAmount: double.tryParse(
                                _model.yourIncomeTextController.text),
                          ));
