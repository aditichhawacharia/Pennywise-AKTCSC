...
export '/pages/create_expense_begin/create_expense_begin_widget.dart'
    show CreateExpenseBeginWidget;
export '/pages/m_y_card/m_y_card_widget.dart' show MYCardWidget;
export '/pages/m_y_expenses/m_y_expenses_widget.dart' show MYExpensesWidget;
...
export '/pages/create_expense/create_expense_widget.dart'
...
export '/pages/onboarding_debts/onboarding_debts_widget.dart'
    show OnboardingDebtsWidget;
export '/pages/create_debt_begin/create_debt_begin_widget.dart'
    show CreateDebtBeginWidget;
export '/pages/create_debt/create_debt_widget.dart' show CreateDebtWidget;
export '/pages/m_y_debts/m_y_debts_widget.dart' show MYDebtsWidget;
export '/debt_details/debt_details_widget.dart' show DebtDetailsWidget;
export '/budget/budget_widget.dart' show BudgetWidget;
export '/pages/update_debt/update_debt_widget.dart' show UpdateDebtWidget;
